...
const BottomNav: React.FC = () => {
    ...
    // Creator nav items - no discover, has mint
    ...
    // Listener nav items - has discover, no mint
    const listenerNavItems: NavItem[] = [
        {
            path: '/home',
            label: 'Home',
            icon: (
    ...
    const navItems = userRole === 'creator' ? creatorNavItems : listenerNavItems;
